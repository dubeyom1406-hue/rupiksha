                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="border border-slate-100 rounded-xl overflow-hidden">
                                <table className="w-full text-xs">
                                    ...
                                    <tbody>
                                        <tr className="border-t border-slate-50"><td className="px-4 py-2.5 font-bold text-slate-600">SuperAdmin Platform Fee — {selected.period}</td><td className="px-4 py-2.5 text-right font-black text-slate-700">₹ {parseFloat(selected.amount).toLocaleString('en-IN', { maximumFractionDigits: 0 })}</td></tr>
