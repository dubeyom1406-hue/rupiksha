...
const Distributors = () => {
    ...
    const filtered = distributors.filter(d => {
        const matchesSearch = (d.name || d.username || d.businessName || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
                                ...
                                <form onSubmit={handleInvite} className="p-10 space-y-6">
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input required type="password" value={addForm.password} onChange={e => setAddForm({ ...addForm, password: e.target.value })} className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-3 px-5 text-sm font-bold text-slate-900 focus:outline-none focus:border-amber-500 transition-all" />
                                        </div>
