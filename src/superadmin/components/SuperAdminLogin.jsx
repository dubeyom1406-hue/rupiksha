...
const SuperAdminLogin = () => {
    ...
    const handleLogin = (e) => {
        ...
        const match = sharedDataService.getSuperAdminByCredential(loginForm.username, loginForm.password);
        setTimeout(() => {
            if (match) {
    ...
    const handleRegister = (e) => {
        ...
        setTimeout(() => {
            ...
            const acc = sharedDataService.registerSuperAdmin({ ...regForm, password: '' });
            setNewAccount(acc);
            setRegLoading(false);
            setMode('success');
        }, 800);
        ...
        <div className="space-y-5">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
                <div className="relative">
                    ...
                    <input type="text" placeholder="SuperAdmin ID / Mobile"
                ...
                >
                    {loginLoading
                        ...
                        : <><span>Login as SuperAdmin</span><ArrowRight size={16} /></>
                    }
                </button>
                ...
                >
                    <Building2 size={15} /> Apply as SuperAdmin
                </button>
                <p className="text-center text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                    Demo: <span className="text-indigo-600">superadmin</span> / <span className="text-indigo-600">admin</span>
                </p>
                <p className="text-center text-[8px] font-bold text-slate-300 uppercase tracking-widest mt-2 italic">
                    Note: Registration ID format is SUPXXXXXX
                </p>
            </form>
        </div>
    );
