    ...
    <div style={{ animation:"fadeIn 0.4s ease" }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14, marginBottom:14 }}>
        ...
        <Card title="AEPS KYC" icon="🛡️" accent="#10b981">
          <StatRow label="Aeps KYC Done"    value={fmt(s.aepsKyc?.done)}    accent="#4ade80"/>
          <StatRow label="Aeps KYC Not Done" value={fmt(s.aepsKyc?.notDone)} accent="#f87171"/>
          <StatRow label="Aeps KYC Pending"  value={fmt(s.aepsKyc?.pending)} accent="#fbbf24"/>
        </Card>
