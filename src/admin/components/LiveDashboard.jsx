...
const LiveDashboard = ({ data: parentData, distributors: parentDists, superadmins: parentSAs }) => {
    ...
    return (
        <div style={{
            ...
            {/* ── KPI Cards Row ── */}
            <div className="live-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)', marginBottom: 16 }}>
                ...
                <KpiCard title="AEPS KYC" icon="🛡️" accent="#10b981">
                    <StatRow label="AEPS KYC Done" value={fmt(liveData.aepsKyc.done)} accent="#10b981" />
                    <StatRow label="AEPS KYC Not Done" value={fmt(liveData.aepsKyc.notDone)} accent="#ef4444" />
                    <StatRow label="AEPS KYC Pending" value={fmt(liveData.aepsKyc.pending)} accent="#f59e0b" />
                </KpiCard>
