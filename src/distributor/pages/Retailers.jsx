...
const Retailers = () => {
    ...
    const [formData, setFormData] = useState({ name: '', businessName: '', mobile: '', email: '', password: '', state: 'Bihar', city: '' });
    ...
    const handleVerifyAndAdd = async () => {
        ...
        setVerifying(true);
        try {
            const newUser = dataService.registerUser(formData, dist.id);
            ...
            setFormData({ name: '', businessName: '', mobile: '', email: '', password: generatePassword(), state: 'Bihar', city: '' });
            setShowSuccess(true);
        } catch (err) {
